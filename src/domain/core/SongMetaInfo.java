 ...
 * song, genre, a list with the name of one or more artists and the name of the album. Implements 
 * RegExpMatchable considering that some information available (the name, some of the artists' names, 
